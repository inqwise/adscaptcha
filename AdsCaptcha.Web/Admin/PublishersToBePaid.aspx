<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="PublishersToBePaid.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.PublishersToBePaid" %>
    ...
    <div id="subNavigation">
        <div class="subNavigation">
            <ul>
                ...
                <li><a href="PublishersToBePaid.aspx" class="selected">To Be Paid</a></li>
                ...
                <ComponentArt:Grid ID="Grid" 
                    ...
                    <ClientTemplates>                        
                        ...
                        <ComponentArt:ClientTemplate ID="ActionsTemplate">
                            <a href='CreditPublisher.aspx?PublisherId=##DataItem.GetMember("Publisher_Id").Value##'>Credit</a>
                        </ComponentArt:ClientTemplate>
