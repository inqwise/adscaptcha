...
{
    public partial class CreditDeveloperBank : System.Web.UI.Page
    {
        ...
        {
            // Get bank details.
            TD_DEVELOPER_BANK bank = DeveloperBLL.GetDeveloperBankDetails(_developer.Developer_Id);
        ...
        protected void buttonSubmit_Click(object sender, EventArgs e)
        {
            ...
            // Credit publisher.
            DeveloperBLL.CreditBank(developerId, amountToCredit, null, authNumber, accountNumber, bankName, branchName, holderName, bankCode, address, city, state, country, additionalData);
