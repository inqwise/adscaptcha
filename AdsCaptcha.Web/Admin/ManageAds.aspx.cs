    ...
    public partial class ManageAds : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                campaignId = int.Parse(Page.Request.QueryString["CampaignId"].ToString());
        ...
        private void InitControls()
        {
            ...
            labelBreadCrambs.Text = "<a href='ManageAdvertisers.aspx'>" + "Advertisers" + "</a>" + " » " +
                                    ...
                                    "Campaign: " + _campaign.Campaign_Name + " (<a href='EditCampaign.aspx?AdvertiserId=" + _campaign.Advertiser_Id.ToString() + "&CampaignId=" + _campaign.Campaign_Id.ToString() + "'>edit</a>)";
        ...
        private void InitFilterData()
        {
            ...
            filterData.AdvertiserId = _campaign.Advertiser_Id;
            filterData.CampaignId = _campaign.Campaign_Id;
        ...
        private void GetData(bool bindGrid)
        {
            if (Session[kSessionFilterData] != null)
            {
                ...
                int campaignId = filterData.CampaignId;
                ...
                // TODO: Move to BLL?
                // Get ads list.
                Grid.DataSource = dataContext.Admin_GetAdsList(advertiserId, campaignId, statusId).ToList();
