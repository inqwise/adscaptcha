<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="ManageAdvertisers.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.ManageAdvertisers" %>
            ...
            <div>
                <table width="100%">
                    <tr>
                        ...
                        <td class="right">
                            <a href="NewAdvertiser.aspx" class="button"><span>+ Add New Advertiser</span></a>
                        </td>
                    </tr>                    
                </table>
                ...
                <ComponentArt:Grid ID="Grid" 
                    ...
                    <Levels>
                        <ComponentArt:GridLevel 
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="Email" Align="Left" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DataCellClientTemplateId="NameTemplate" Width="300"/>
                                ...
                                <ComponentArt:GridColumn DataField="Campaigns" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Descending" FormatString="N0" DataCellClientTemplateId="CampaignsTemplate" />
                    ...
                    <ClientTemplates>                        
                        ...
                        <ComponentArt:ClientTemplate ID="CampaignsTemplate">
                            <a href="ManageCampaigns.aspx?AdvertiserId=## DataItem.getMember('Advertiser_Id').get_value() ##">## DataItem.getMember('Campaigns').get_value() ##</a>
                        </ComponentArt:ClientTemplate>                
                        ...
                        <ComponentArt:ClientTemplate ID="ActionsTemplate">
                            <a href='EditAdvertiser.aspx?AdvertiserId=##DataItem.GetMember("Advertiser_Id").Value##'>Edit</a> | 
                            <a href='NewCampaign.aspx?AdvertiserId=##DataItem.GetMember("Advertiser_Id").Value##'>Add Campaign</a>
                        </ComponentArt:ClientTemplate>
