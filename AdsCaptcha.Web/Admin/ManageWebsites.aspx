<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="ManageWebsites.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.ManageWebsites" %>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td class="right">
                            ...
                            <a href="NewWebsite.aspx?DeveloperId=<%=developerId%>&PublisherId=<%=publisherId%>" class="button"><span>+ Add New Website</span></a>
                        </td>
                    </tr>
                </table>
                ...
                <ComponentArt:Grid ID="Grid" 
                    ...
                    <Levels>
                        <ComponentArt:GridLevel 
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="Url" HeadingText="Url" Align="Left" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DataCellClientTemplateId="NameTemplate" Width="240" />
                    ...
                    <ClientTemplates>                        
                        ...
                        <ComponentArt:ClientTemplate ID="IdTemplate">
                            <a href="ManageCaptchas.aspx?DeveloperId=## DataItem.getMember('Developer_Id').get_value() ##&PublisherId=## DataItem.getMember('Publisher_Id').get_value() ##&WebsiteId=## DataItem.getMember('Website_Id').get_value() ##">## DataItem.getMember('Website_Id').get_value() ##</a>
                        </ComponentArt:ClientTemplate>
                        ...
                        <ComponentArt:ClientTemplate ID="CaptchasTemplate">
                            <a href="ManageCaptchas.aspx?DeveloperId=## DataItem.getMember('Developer_Id').get_value() ##&PublisherId=## DataItem.getMember('Publisher_Id').get_value() ##&WebsiteId=## DataItem.getMember('Website_Id').get_value() ##">## DataItem.getMember('Captchas').get_value() ##</a>
                        </ComponentArt:ClientTemplate>                
                        ...
                        <ComponentArt:ClientTemplate ID="ActionsTemplate">
                            <a href='EditWebsite.aspx?DeveloperId=## DataItem.getMember('Developer_Id').get_value() ##&PublisherId=## DataItem.getMember('Publisher_Id').get_value() ##&WebsiteId=## DataItem.getMember('Website_Id').get_value() ##'>Edit</a> | 
                            <a href='NewCaptcha.aspx?DeveloperId=## DataItem.getMember('Developer_Id').get_value() ##&PublisherId=## DataItem.getMember('Publisher_Id').get_value() ##&WebsiteId=## DataItem.getMember('Website_Id').get_value() ##'>Add Captcha</a>
                        </ComponentArt:ClientTemplate>
