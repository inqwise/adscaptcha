<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="ViewPaymentsDev.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.ViewPaymentsDev" %>
    ...
    <div id="subNavigation">
        <div class="subNavigation">
            <ul>
                ...
                <li><a href="ViewPaymentsDev.aspx" class="selected">Payments To Developers</a></li>
            ...
            <div>
                <table>
                    <tr>
                        <td><b>Developer:</b></td>
                        <td>
                            <asp:DropDownList ID="listDevelopers" runat="server" AutoPostBack="true"
                                CssClass="SelectField"  
                                onselectedindexchanged="listDevelopers_SelectedIndexChanged" />
                        </td>
                    </tr>
                    <tr>
                        <td><b>From:</b></td>
                ...
                <ComponentArt:Grid ID="Grid" 
                    ...
                    <Levels>
                        <ComponentArt:GridLevel 
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="Developer_Id" HeadingText="ID" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DataCellClientTemplateId="DeveloperIdTemplate" Width="30" />
                    ...
                    <ClientTemplates>                        
                        ...
                        <ComponentArt:ClientTemplate ID="DeveloperIdTemplate">
