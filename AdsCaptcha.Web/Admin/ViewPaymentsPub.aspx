<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="ViewPaymentsPub.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.ViewPaymentsPub" %>
...
<asp:content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="subNavigation">
        <div class="subNavigation">
            <ul>
                <li><a href="ViewCharges.aspx">Charges From Advertisers</a></li>
                <li><a href="ViewPaymentsPub.aspx" class="selected">Payments To Site Owners</a></li>
            ...
            <div>
                ...
                <ComponentArt:Grid ID="Grid" 
                    ...
                    <Levels>
                        <ComponentArt:GridLevel 
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="Publisher_Id" HeadingText="ID" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DataCellClientTemplateId="PublisherIdTemplate" Width="30" />
                                <ComponentArt:GridColumn DataField="Email" HeadingText="Site Owner" Align="Left" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DataCellClientTemplateId="NameTemplate" />
                    ...
                    <ClientTemplates>                        
                        ...
                        <ComponentArt:ClientTemplate ID="PublisherIdTemplate">
                            <a href="ManageWebsites.aspx?PublisherId=## DataItem.getMember('Publisher_Id').get_value() ##">## DataItem.getMember('Publisher_Id').get_value() ##</a>
                        </ComponentArt:ClientTemplate>
