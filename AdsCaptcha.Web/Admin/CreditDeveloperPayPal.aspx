<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="CreditDeveloperPayPal.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.CreditDeveloperPayPal" %>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="validatorAccountName1" 
