<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="NewCaptcha.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.NewCaptcha" %>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="validatorCaptchaName1"
                                ...
                                <asp:CustomValidator ID="validatorCaptchaName2"  
                                    runat="server" ControlToValidate="textCaptchaName" Display="Dynamic"
