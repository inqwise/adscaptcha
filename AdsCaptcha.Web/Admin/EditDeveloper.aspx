<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="EditDeveloper.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.EditDeveloper" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="validatorCountry"
                                    runat="server" ControlToValidate="listCountry" ValidationGroup="Form"
