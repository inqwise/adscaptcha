<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="NewPublisher.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.NewPublisher" %>
    ...
    <div id="subNavigation">
        <div class="subNavigation">
            ...
            %>
                ...
                <li><a href="NewPublisher.aspx" class="selected">New Site Owner</a></li>
                ...
                <div class="Section">        
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="checkBranded" runat="server" Checked="true" />
                            </td>
                        </tr>
                    </table>
                </div>
