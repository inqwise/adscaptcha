...
{
    public partial class AdvertisersToBeCharged : System.Web.UI.Page
    {
        ...
        private void GetData(bool bindGrid)
        {
            ...
            // TODO: Move to BLL?
            // Get advertisers to be charged list.
            Grid.DataSource = dataContext.Admin_GetAdvertisersToBeChargeList().ToList();
