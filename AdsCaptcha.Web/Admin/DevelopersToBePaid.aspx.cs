...
{
    public partial class DevelopersToBePaid : System.Web.UI.Page
    {
        ...
        private void GetData(bool bindGrid)
        {
            ...
            // TODO: Move to BLL?
            // Get developers to be paid list.
            Grid.DataSource = dataContext.Admin_GetDevelopersToBePaidList().ToList();
