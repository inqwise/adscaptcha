<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="EditAd.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.EditAd" %>
...
<asp:Content ContentPlaceHolderID="Header" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        previewSlogan = '<% =textAdSlogan.Text %>' == '' ? previewSlogan : '<% =textAdSlogan.Text %>';
        previewURL = "/handlers/Image.ashx?AdId=<%=_ad.Ad_Id%>";
        previewWidth = <% =UploadWidth.Value %> == 0 ? previewWidth : <% =UploadWidth.Value %>;
        previewHeight = <% =UploadHeight.Value %> == 0 ? previewHeight : <% =UploadHeight.Value %>;
        ...
        $(document).ready(function() {
            ...
            var isRtl = $('#<% =checkRtl.UniqueID.Replace("$","_") %>:checked').val();
            ...
            objPreview
                .load(function() {                    
                    ...
                    previewURL = $('#<% =UploadPreview.UniqueID.Replace("$","_") %>').attr("src");
                    //alert(previewURL);
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table> 
                                                ...
                                                <tr>
                                                    <td class="FieldFrameHeader">Status:*</td>
                                                    <td>
                                                        <asp:DropDownList ID="listStatus" CssClass="SelectFrameField" runat="server" ValidationGroup="Form" DataTextField="Item_Desc" DataValueField="Item_Id" />
                                                ...
                                                <tr id="AdTypeImageHolder" runat="server" style="display:<%=displayImage%>;">
                                                    <td class="FieldFrameHeader">Image:*</td>
                                                    <td>
                                                        <input id="UploadHidden" runat="server" type="hidden" value="" />
                                                        <div id="UploadImageHolder">
                                                            <img id="imgPreview" src="/handlers/Image.ashx?AdId=<%=_ad.Ad_Id%>"; />
                            ...
                            <td width="30%" class="previewCaptcha">
                                <div id="AdTypeHolder0" runat="server" class="previewCaptchaHolder"> <!-- slogan only -->
                                    <script type="text/javascript">
                                        ...
                                        GetCaptcha(type, previewSlogan, null, previewWidth, previewHeight, previewDir, previewThemeId);
                                    </script>
                                </div>
                                ...
                                <div id="AdTypeHolder3" runat="server" class="previewCaptchaHolder"> <!-- video -->
                                    <script type="text/javascript">
                                        ...
                                        GetCaptcha(type, previewSlogan, null, 0, 0, previewDir, previewThemeId);
                                    </script>
                                </div>
