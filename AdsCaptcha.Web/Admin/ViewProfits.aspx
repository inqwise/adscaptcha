<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeFile="ViewProfits.aspx.cs" Inherits="Inqwise.AdsCaptcha.Admin.ViewProfits" %>
    ...
    <div id="subNavigation">
        <div class="subNavigation">
            <ul>
                ...
                <li><a href="ViewProfits.aspx" class="selected">Daily Net Income</a></li>
            </ul>
        </div>
    </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            ...
            <div>
                ...
                <ComponentArt:Grid ID="Grid" 
                    ...
                    EmptyGridText="No profits found."
                    PageSize="5000"
                    ScrollBar="Auto"
                    ...
                    <Levels>
                        <ComponentArt:GridLevel 
                            ...
                            <Columns>
                                ...
                                <ComponentArt:GridColumn DataField="Types" FixedWidth="true" Width="80" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" />
                                <ComponentArt:GridColumn DataField="Profit" FixedWidth="true" Width="80" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Descending" FormatString="C0" />
                            </Columns>
                        </ComponentArt:GridLevel>
                    </Levels>
