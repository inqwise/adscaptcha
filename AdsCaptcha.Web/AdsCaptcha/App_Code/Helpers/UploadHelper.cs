...
namespace Inqwise.AdsCaptcha.Helpers
{
    public class UploadHelper
    {
        ...
        public NewImageArgs FileUploadHandle(HttpPostedFile uploadedFile, NewImageArgs file)
        {
            if (Validate(uploadedFile, file))
            {
                ...
                file.RelativeFilePath = FileNamePrefix + file.Name.StripNonAsciiChars();
                file.AbsoluteFilePath = Path.Combine(this.UploadDir, file.RelativeFilePath);
                ...
                {
                    var dirPath = Path.GetDirectoryName(file.AbsoluteFilePath);
