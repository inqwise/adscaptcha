<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="~/OldAdsCaptcha.Master" AutoEventWireup="true" CodeFile="Forgot.aspx.cs" Inherits="Inqwise.AdsCaptcha.Advertiser.Forgot" %>
    ...
    <div id="status">
        <div class="inner-status">
            <div class="status-box">
                <h2>Advertisers, Forgot password</h2><!-- <div class="status-number">144,453,448</div> -->
            </div><!--end status-box-->
                ...
                <tr>
                    <td>                
                        <asp:Panel ID="panelForm" runat="server" Visible="true">
                            ...
                            <br />
                            E-mail: <asp:TextBox CssClass="InputField" ID="textEmail" runat="server" MaxLength="100" Width="200px" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="textEmail" ValidationGroup="Form"
                                CssClass="ValidationMessage" ErrorMessage="* Required" Display="dynamic" SetFocusOnError="true" ID="RfTextEmail" />
                            <asp:RegularExpressionValidator runat="server"
                                ControlToValidate="textEmail" ValidationGroup="Form" 
                                ValidationExpression=".*@.*\..*"
                                CssClass="ValidationMessage" ErrorMessage="* Invalid email format"
                                Display="dynamic" SetFocusOnError="true" ID="ReTextEmail" />
                            <asp:CustomValidator runat="server" ControlToValidate="textEmail" Display="Dynamic"
                                OnServerValidate="checkEmailExists_ServerValidate" ValidationGroup="Form"
                                CssClass="ValidationMessage" ErrorMessage="* Email does not exist" SetFocusOnError="true" ID="CvTextEmail" />
                            <br />
                            
                            <asp:Label ID="labelErrorMessage" runat="server"  CssClass="errorMessage"></asp:Label>
