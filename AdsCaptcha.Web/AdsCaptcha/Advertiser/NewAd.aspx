<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="~/Advertiser/AdvertiserAccount.Master" AutoEventWireup="true" CodeFile="NewAd.aspx.cs" Inherits="Inqwise.AdsCaptcha.Advertiser.NewAd" %>
...
#content .description { padding-left:20px;}
</style>
</asp:Content>
        		...
        		<div id="top-content">
                    <div class="menu-right">
                    	<ul style="width:auto;text-align:right;">
    	                	<li class="none"><a class="current" href="ManageAds.aspx?CampaignId=<%=Page.Request.QueryString["CampaignId"]%>" style="color: #7C7C7C;">Manage Ads</a></li>
    	                </ul>
                    </div>
                </div>
	        		...
	        		<tr>
	        			<td valign="top">
				        	...
				        	<div class="description">
					        	...
					        	<div class="params" style="padding-top: 12px; clear: both;">
				    			...
				    			<div class="params" style="padding-top: 12px; clear: both;">
				    				...
				    				<div class="param-value">
				    					<div><span>$</span><input type="text" id="text_max_bid" name="max_bid" autocomplete="off" value="<%=LastAdMaxBid %>" class="InputField" /><a style="display: none">This defines what an advertiser will pay when a user successfully clicks/fits the ad.</a>&nbsp;<img rel="This defines what an advertiser will pay when a user successfully clicks/fits the ad." class="tooltip" src="../css/Inqwise/images/helpicon.png"></div>
				    			...
				    			<div class="params">
				    				...
				    				<div class="param-value">
				    					<div>
				    						<input type="text" id="text_image_click_url" name="image_click_url" autocomplete="off" class="InputField" value="<%=LastAdClickUrl %>" /><a id="link_check_image_click_url" title="Check URL" target="_blank" class="ui-link-disabled" style="margin-left: 6px;">Check URL</a>&nbsp;<img rel="the image in the captcha can be clickable, insert here the target site or landing page URL , were you want to drive your traffic" class="tooltip" src="../css/Inqwise/images/helpicon.png">
				    					</div>
				    			...
				    			<div class="params">
				    				...
				    				<div class="param-value">
				    					<div><input type="text" id="text_facebook_like_url" name="facebook_like_url" autocomplete="off" value="<%=LastAdLikeUrl%>" class="InputField" /><a id="link_check_facebook_like_url" title="Check URL" target="_blank" class="ui-link-disabled" style="margin-left: 6px;">Check URL</a>&nbsp;<img rel="Insert here You Facebook page URL, when users will click on the &lt;b&gt;Like&lt;/b&gt; button they will become fans" class="tooltip" src="../css/Inqwise/images/helpicon.png"></div>
		...
		accept : function () {
			...
			if($('#hidden_ad_image_id').val() != "") {
				...
				create({
					...
					campaignId : $.getUrlParam("CampaignId"),
					success : function(data) {
						if(data.adId != undefined) {
