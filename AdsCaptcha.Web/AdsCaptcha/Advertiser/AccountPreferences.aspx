<%@ Page CodeFile="AccountPreferences.aspx.cs" EnableViewStateMac="false" Language="C#" MasterPageFile="~/Advertiser/AdvertiserAccount.Master" AutoEventWireup="true" Inherits="Advertiser_AccountPreferences" %>
...
#content .inner-content, #content-form {
 ...
 <style type="text/css">
  ...
  <script type="text/javascript">
      ...
      $('select#<%=listBillingMethod.ClientID %>').selectmenu({ width: 215 });
      $('select#<%=listPaymentMethod.ClientID %>').selectmenu({ width: 215 });
      });
	</script>
</asp:Content>
    ...
    <div id="breadCrambs">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            ...
            <div class="description">
	            <div>
	            <br /><br />
            <asp:Label ID="labelChangesSaved" runat="server" CssClass="ChangesSaved" Text="Changes saved successfully." Visible="false" />
            ...
            <div class="description">
                <table>
                    <tr>
                        <td class="FieldHeader" style="vertical-align: top">Payment Method:*</td>
                        <td>                            
                            <asp:Label ID="labelPaymentMethod" runat="server" Visible="false" ></asp:Label>
                            <asp:DropDownList ID="listPaymentMethod" runat="server" CssClass="SelectField" style="float:left;" ValidationGroup="Form" />
                            ...
                            <span ID="panelCreditCardError" runat="server" Visible="false" class="note" style="width:300px;float: right;margin: 10px 0 0 10px;">
                                <p>
                                    Your credit card is invalid or details are missing. Click <a href="BillingCreditCard.aspx">here</a> to update your credit card details.
                                    <br />                                    
                                    Your ads won't be displayed until you verify your credit card details.
                                </p>
                            </span>
                             <span ID="panelCreditCardValid" runat="server" Visible="false" class="note" style="width:300px;float: right;margin: 10px 0 0 10px">
                                <p>
                                    Click <a href="BillingCreditCard.aspx">here</a> to enter a new credit card.
                                </p>
                             </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="labelBillingMethod" runat="server" Visible="false"></asp:Label>
                            ...
                            <asp:CustomValidator ID="validatorBillingMethod2"
                                ...
                                CssClass="ValidationMessage" SetFocusOnError="true" />
                            <asp:Panel ID="panelPrepay" runat="server" Visible="false">
                                <p>
                                    Your balance is: $<asp:Label ID="labelPrepayBalance" runat="server"></asp:Label>. Click <asp:LinkButton ID="linkPrepay" runat="server">here</asp:LinkButton> to add credit.
                                </p>
                            </asp:Panel>
                        </td>
                    </tr>
            ...
            <div class="description">
                <p>The address where we will send your invoices.</p>
                <table>
                    <tr>
            ...
            <div id="buttonHolder">                
                ...
                <a id="buttonCancel" class="btn" style="color:#FFFFFF;" href="ManageCampaigns.aspx"><span>Cancel</span></a>
            </div>
            </div>
            </div>
            </ContentTemplate>
