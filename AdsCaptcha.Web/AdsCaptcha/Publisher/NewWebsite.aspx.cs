...
{
    public partial class NewWebsite : System.Web.UI.Page, IPublisherNewWebsite
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                int publisherId = Convert.ToInt32(Session["PublisherId"]);
                var publisherResult = PublishersManager.Get(publisherId);
