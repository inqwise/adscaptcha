<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="~/Publisher/PublisherAccount.Master" AutoEventWireup="true" CodeFile="NewCaptcha.aspx.cs" Inherits="Inqwise.AdsCaptcha.Publisher.NewCaptcha" %>
...
var campaignId = <%=Website.CampaignId as object ?? "null"%>;
...
$(function() {
			...
			var dimensions = $('#select_dimensions').val();
				...
				create({
					...
					success : function(data) {
						...
						location.href = "/publisher/GetCode.aspx?WebsiteId=<%=Request.QueryString["WebsiteId"]%>&CaptchaId=" + data.captchaId;
	...
	*/
	...
	if(campaignId != null) {
		...
		// set captcha type
		$("input:radio[name=captcha_type][value=2]")
			.prop("checked", true)
			.change();
