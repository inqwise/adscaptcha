<%@ Page EnableViewStateMac="false" Language="C#" MasterPageFile="~/Publisher/PublisherAccount.Master" AutoEventWireup="true" CodeFile="EarningsSummary.aspx.cs" Inherits="Inqwise.AdsCaptcha.Publisher.EarningsSummary" %>
       ...
       <!--div id="breadCrambs">
        ...
        <div class="inner-content">
            ...
            <asp:Panel ID="PanelGrid" runat="server" Visible="true">        
                ...
                <asp:UpdatePanel ID="UpdatePanel" runat="server">
                    ...
                    <asp:UpdateProgress ID="UpdateProgress" runat="server"> 
                      ...
                      <label>Website:</label>
                      <asp:DropDownList ID="listWebsite"  Width="120" runat="server" AutoPostBack="true" 
                                    CssClass="SelectField" DataValueField="Website_Id" DataTextField="Url" 
                                    onselectedindexchanged="listWebsite_SelectedIndexChanged" />
                    </div>
        	         <div class="menu-right">
        	                <ul  style="width:auto;text-align:right;">
                            <li class="active"><a href="EarningsSummary.aspx">Earnings Summary</a></li>
                            <li  class="none"><a href="PaymentHistory.aspx">History</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <br />
             ...
             <!--ul class="tabs">
	            <li><a href="EarningsSummary.aspx" class="current">Earnings Summary</a></li>
	            <li><a href="PaymentHistory.aspx">Payment History</a></li>
                        ...
                        <Levels>
                            <ComponentArt:GridLevel 
                                ...
                                <Columns>
                                    ...
                                    <ComponentArt:GridColumn DataField="Date" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Descending" FooterCellClientTemplateId="TotalTemplate" FixedWidth="true" Width="90" />
                                    <ComponentArt:GridColumn DataField="Website_Id" Visible="False" />
                                    <ComponentArt:GridColumn DataField="Url" HeadingText="Website" Align="Left" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Ascending" />
                                    <ComponentArt:GridColumn DataField="Types" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Descending" FormatString="N0" FooterCellClientTemplateId="SummaryCountTemplate" FixedWidth="true" Width="80" />
                                    <ComponentArt:GridColumn DataField="Fits" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Descending" FormatString="N0" FooterCellClientTemplateId="SummaryCountTemplate" FixedWidth="true" Width="80" />
                                    <ComponentArt:GridColumn DataField="Earnings" Align="Center" HeadingCellClientTemplateId="HeadingSortableCellTemplate" AllowSorting="True" DefaultSortDirection="Descending" DataCellClientTemplateId="CurrencyTemplate" FooterCellClientTemplateId="SummaryCurrencyTemplate" FixedWidth="true" Width="80" />
                                    <ComponentArt:GridColumn AllowSorting="False" FixedWidth="true" Width="400" AllowReordering="False" />
                                </Columns>
                            </ComponentArt:GridLevel>
                        </Levels>
                    ...
                    <p class="note">
                    * Reporting is not real time. Types and earnings received in the last 12 hours may not be included.
                    </p>
                    </div>
        	...
        	<div class="top tr header">
            	<div class="td w300">Last Payment</div>
                <div class="td w300">Payment Method</div>
                <div class="td w300">Total Earnings</div>
                <div class="clear"></div>
            </div>
            <div class="tr">
            	<div class="td w300"><asp:Literal ID="labelLastPayment" runat="server"></asp:Literal></div>
                <div class="td w300"><asp:Literal ID="labelPaymentMethod" runat="server"></asp:Literal></div>
                <div class="td w300"><asp:Literal ID="labelEarningsSum" runat="server"></asp:Literal></div>

                <div class="clear"></div>
            </div>
            <div class="tr footer">
            	<div class="td w300"><a href="PaymentHistory.aspx" class="SmallLink" style="color:#fff;">View payment history</a></div>
                <div class="td w300">Min. check amount: <asp:Literal ID="labelMinCheckAmount" runat="server"></asp:Literal></div>
                <div class="clear"></div>
            </div>
        </div><!--end table-->
