<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TestSlider300.aspx.cs" Inherits="TestSlider300" %>
        ...
        <tr>
            ...
            <div style="width:68px;margin: -20px 0 0 50px; text-align:center;color: #5B5757;font-family: 'oswaldregular';font-size: 27px;font-weight: 400;">Are You a Robot?</div>
             ...
             <td  style="width:400px;"><div id="sliderholder">
          		<script type="text/javascript" src="<%=ApplicationConfiguration.ApiUrl.Value %>slider/get.ashx?imageTypeId=5&w=300&h=250"></script>
          	</div>
          </td>
