<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Feedback.aspx.cs" Inherits="Inqwise.AdsCaptcha.API.Slider.Feedback" %>
        ...
        $(document).ready(function() {
            $("#btnSend").click(function() {
                if (Validate()) {
                    ...
                    dataToSubmit += "&referrer=" + encodeURI(window.document.referrer);
